    ...
    <div class="main-wrapper">
        <div class="flex-container">
            ...
            <ul class="navigation__itens" id="menu">
                ...
                <li>
                    <a href="{{route('site.produtos')}}">Produtos
                        <span class="border-effect"></span>
                    </a>
                </li>
                <li>
...
<div id="resize">
    <ul id="menu">
        ...
        <li><a class="title-medium" href="{{route('site.produtos')}}">Produtos</a></li>
        <li><a class="title-medium" href="{{route('site.blog')}}">Blog</a></li>
        <li><a class="title-medium" href="{{route('site.sobre')}}">Sobre</a></li>
        <li><a class="title-medium" href="{{route('site.contato')}}">Contato</a></li>
    </ul>
</div>
    ...
    <div class="main-wrapper flex-container">
        ...
        <ul>
            ...
            <li class="footer__links">
                ...
                <a href="{{route('site.produtos')}}">Nossos produtos</a>
                <a href="{{route('site.sobre')}}">Sobre nós</a>
                <a href="{{route('site.contato')}}">Entre em contato</a>
            </li>
            <li class="footer__links">
